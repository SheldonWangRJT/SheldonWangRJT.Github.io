...
<script>
    ...
    const aug2025Data = [78, 709.2, 285.5, 41.4, 18.6, 821.0]; // Pre-calculated from expressions + 90 real estate
...
|---|---|---|---|
| Cash | 5.22% | 3.99% | <span style="color: #ff6b6b;">-1.23%</span> |
| Stocks | 30.28% | 36.30% | <span style="color: #51cf66;">+6.02%</span> |
| 401k | 13.13% | 14.61% | <span style="color: #51cf66;">+1.48%</span> |
| HSA | 2.05% | 2.12% | <span style="color: #51cf66;">+0.07%</span> |
| Crypto | 0.74% | 0.95% | <span style="color: #51cf66;">+0.21%</span> |
| Real Estate | 48.57% | 42.03% | <span style="color: #ff6b6b;">-6.54%</span> |

**Total Net Worth Growth: <span style="color: #51cf66;">+11.5%</span>** (from baseline December 2024)